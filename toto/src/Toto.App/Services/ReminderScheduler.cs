...
{
    private readonly ItemRepository items; private readonly SettingsRepository settings; private readonly WorkCalendarService calendar; private readonly System.Threading.Timer timer; private readonly SynchronizationContext context;
    ...
    {
        this.items = items; this.settings = settings; this.calendar = calendar; context = SynchronizationContext.Current ?? new WindowsFormsSynchronizationContext(); timer = new System.Threading.Timer(_ => Tick(), null, Timeout.Infinite, Timeout.Infinite);
    }
