...
internal enum DayType { Rest = 0, Workday = 1 }
...
internal sealed record WorkCalendarException(DateOnly Date, DayType DayType, string Name, string Note, string Source, DateTime UpdatedAt);
