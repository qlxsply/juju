...
public partial class App : System.Windows.Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        var documents = new JsonDocumentService(ApplicationPaths.DataRoot, new JsonMetadataStore(ApplicationPaths.DataRoot, writer), writer, new DocumentRevisionService());
